...
const RequestOutgoing: React.FC<Request> = (props: Request) => {
  ...
  <div className='request' key={props.index}>
    <div className='header'>
        <span className='title'>Request for <NavLink to={`assets/${props.requestProps.asset_id}`}>{props.requestProps.asset_id.title}</NavLink></span>
    </div>
    <div className='description'>
      <span>You requested <NavLink to={`assets/${props.requestProps.asset_id}`}>{props.requestProps.asset_id.title}</NavLink> from user <NavLink to={`/user/${props.requestProps.requestee.username}`}>{props.requestProps.requestee.username}</NavLink>.</span>
    </div>
