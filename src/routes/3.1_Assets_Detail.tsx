...
function AssetsDetail() {
    ...
    const [portalContainer, setPortalContainer] = useState(document.getElementById("asset-container"))
        ...
        <div id='asset-container'>
            <div className='header'>
                <div> 
                    ...
                    <span>&nbsp;&nbsp;by&nbsp;<NavLink to='/user/1'>&nbsp;{asset.creator}</NavLink></span>
                </div>
            ...
            <span>Created: {asset.created}</span><br/><br/>
            <span>Tags: {asset.type.map(item => <span className='tag'>{item}</span>)}</span><br/><br/>
            <div className='description'>
                <span>Swap for&nbsp;&nbsp;</span><span className='kokans'>{asset.kokans}</span>
                <AlertDialogSwap portalContainer={portalContainer} price={asset.kokans} onSwap={onSwap}/>
            </div>
        </div>
        </div>
    )
